      ...
      <main className="min-h-screen lg:ml-[220px]">
        ...
        <div className="p-4 sm:p-6 lg:p-7">
          ...
          {/* =================================================
              CONTENT GRID
          ================================================== */}
          <section className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-[1.25fr_0.95fr_0.72fr]">
            {/* =================================================
                RECENT EXPENSES
            ================================================== */}
            <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
              <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                ...
                <button
                  ...
                  className="text-[10px] font-semibold text-[#08736b] hover:underline"
                >
                  View all
                </button>
              </div>
                ...
                {expenses.map((expense) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="hidden w-16 text-right text-[8px] text-slate-400 sm:block">
                        {expense.date}
                      </span>
                    </div>
                  );
              ...
              <div className="p-3">
                <button
                  type="button"
                  onClick={() => navigate("/expenses")}
                  className="flex w-full items-center justify-center rounded-lg border border-slate-200 py-2 text-[10px] font-semibold text-slate-500 transition hover:bg-slate-50 hover:text-[#08736b]"
                >
                  View all expenses →
                </button>
              </div>
            ...
            <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
              ...
              <div className="divide-y divide-slate-100">
                {balances.map((balance) => (
                  ...
                  >
                    <div
                      className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[9px] font-bold ${balance.color}`}
                    >
                      {balance.avatar}
                    </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
              ...
              <div className="space-y-2">
                ...
                <QuickAction
                  icon={Users}
                  title="Create Group"
                  subtitle="Add members and start sharing"
                ...
                <QuickAction
                  icon={ArrowDownToLine}
                  title="Settle Up"
                  subtitle="Settle pending balances"
                  onClick={() => navigate("/settlements")}
                />
                ...
                <QuickAction
                  icon={FileText}
                  title="View Reports"
                  subtitle="Check expense reports"
          ...
          <section className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
            <SummaryCard
              ...
              label="Net Balance"
              value="+₹1,220.00"
              description="You are in positive balance"
              positive
            />
            ...
            <SummaryCard
              ...
              label="This Month"
              value="₹24,850.00"
              description="Total shared expenses"
            />
            ...
            <SummaryCard
              ...
              label="Active Groups"
              value="5"
              description="Groups you're participating in"
            />
          </section>
          ...
          {/* =================================================
              FOOTER
          ================================================== */}
          <footer className="flex flex-col items-center justify-between gap-3 px-1 py-6 text-[9px] text-slate-400 sm:flex-row">
            <p>
              © {new Date().getFullYear()} HISSA. Shared expenses made simple.
            </p>

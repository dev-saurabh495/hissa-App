...
:root {
  ...
  --shadow:
    0 24px 70px rgba(22, 47, 43, 0.08);
}
...
.brand-bottom-card > div:nth-child(2) {
  flex: 1;
}

.brand-bottom-card strong {
  display: block;
  font-size: 13px;
}
...
.primary-button {
  ...
  box-shadow:
    0 8px 18px rgba(15, 118, 110, 0.17);
}
...
.primary-button:hover:not(:disabled) {
  ...
  box-shadow:
    0 11px 23px rgba(15, 118, 110, 0.22);
}
